...
function checkFirstName(e) {
	...
	if (target.value.length <= 2) {
		firstName.setAttribute("class","errorfield"); //makes border red
		displayError("Your first name must be greater than 2 characters.", nameFieldset, 3, "firstnameerror");
	} else {
		firstName.setAttribute("class","signupinput"); //makes default grey border
...
function checkLastName(e) {
	...
	// Verify last name is greater than 2 characters
	if (target.value.length <= 2) {
		lastName.setAttribute("class","errorfield"); //makes border red
		displayError("Your last name must be greater than 2 characters.", nameFieldset, 9, "lastnameerror");
	} else {
		lastName.setAttribute("class","signupinput"); //makes default grey border
...
function checkEmail(e) {
	...
	if (!validEmail) {
		...
		email.setAttribute("class","signupinput"); //makes default grey border
...
function checkUsername(e) {
	...
	if (target.value.length <= 7) {
		...
		userName.setAttribute("class","signupinput"); //makes default grey border
...
function checkPassword(e) {
	...
	if ((target.value.length <= 8) && (!validPassword)) {
		...
		password.setAttribute("class","signupinput"); //makes default grey border
...
function matchPassword(e) {
	...
	if (target != passwordValue) {
		...
		passwordConfirm.setAttribute("class","signupinput"); //makes default grey border
